...
export function InfoBox() {
  return (
    <div className="font-comic-sans animate-color-cycle absolute bottom-2 left-2 z-40 max-w-xs rounded-lg border-2 border-dashed border-blue-500 bg-white/80 p-2 text-xs">
